    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$web$2f$calendar$2d$design$2d$and$2d$interaction$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeekView.useMemo[stats]": ()=>{
            const weekDates = weekDays.map({
                "WeekView.useMemo[stats].weekDates": (d)=>d.toISOString().split("T")[0]
    ...
    const { calendarDays, stats, incompleteTasks } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$web$2f$calendar$2d$design$2d$and$2d$interaction$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonthView.useMemo": ()=>{
            ...
            const monthDates = days.filter({
                ...
                "MonthView.useMemo.monthDates": (d)=>d.toISOString().split("T")[0]
            ...
            const incomplete = monthTasks.filter({
                "MonthView.useMemo.incomplete": (t)=>!t.completed
            }["MonthView.useMemo.incomplete"]);
            return {
                calendarDays: days,
                stats: {
                    total,
...
_s(MonthView, "kx3ucu4vlFlkARmVPBQZ3znJRdM=");
_c = MonthView;
var _c;
...
_s(AddTaskSheet, "fEYxxrFfoxGUYZtIUKJ2Eq+99eY=");
_c = AddTaskSheet;
var _c;
...
_s(CategoryManager, "SwP2RHnvkK9rLRzsHby/ljT3QtM=");
_c = CategoryManager;
var _c;
...
function StatisticsView({ open, onOpenChange, tasks, categories }) {
    ...
    // 计算统计数据
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$web$2f$calendar$2d$design$2d$and$2d$interaction$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StatisticsView.useMemo[stats]": ()=>{
            const now = new Date();
            const currentMonth = now.getMonth();
            const currentYear = now.getFullYear();
            // 筛选本月任务
            const monthTasks = tasks.filter({
                "StatisticsView.useMemo[stats].monthTasks": (task)=>{
                    const taskDate = new Date(task.date);
                    return taskDate.getMonth() === currentMonth && taskDate.getFullYear() === currentYear;
                }
            }["StatisticsView.useMemo[stats].monthTasks"]);
            // 按分类统计
            const categoryStats = categories.map({
                "StatisticsView.useMemo[stats].categoryStats": (category)=>{
                    const categoryTasks = monthTasks.filter({
                        "StatisticsView.useMemo[stats].categoryStats.categoryTasks": (task)=>task.category === category.name
                    }["StatisticsView.useMemo[stats].categoryStats.categoryTasks"]);
                    const completed = categoryTasks.filter({
                        "StatisticsView.useMemo[stats].categoryStats": (task)=>task.completed
                    }["StatisticsView.useMemo[stats].categoryStats"]).length;
            ...
            }["StatisticsView.useMemo[stats].categoryStats"]).filter({
                "StatisticsView.useMemo[stats].categoryStats": (stat)=>stat.total > 0
            }["StatisticsView.useMemo[stats].categoryStats"]) // 只显示有任务的分类
            ;
            // 总体统计
            const totalCompleted = monthTasks.filter({
                "StatisticsView.useMemo[stats]": (task)=>task.completed
            }["StatisticsView.useMemo[stats]"]).length;
...
_s(StatisticsView, "3FvJDKtC3yF1gbNv5/WixcrN7Rs=");
_c = StatisticsView;
var _c;
...
_s(CalendarPage, "CxaaLNiG4tJG9WTV7Q4inlR74+M=");
_c = CalendarPage;
var _c;
...
//# sourceMappingURL=Desktop_web_calendar-design-and-interaction_787c7c91._.js.map